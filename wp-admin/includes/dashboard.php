            ...
            <ul>
                <li class="storage-count">
                    ...
                    $text = sprintf(
                            ...
                            __('%s MB Space Allowed'), number_format_i18n($quota)
                    );
                    printf(
                            '<a href="%1$s" title="%2$s">%3$s</a>', esc_url(admin_url('upload.php')), __('Manage Uploads'), $text
                    );
                    ?>
                    ...
                    $text = sprintf(
                            ...
                            __('%1$s MB (%2$s%%) Space Used'), number_format_i18n($used, 2), $percentused
                    );
                    printf(
                            '<a href="%1$s" title="%2$s" class="musublink">%3$s</a>', esc_url(admin_url('upload.php')), __('Manage Uploads'), $text
                    );
                    ?>
                </li>
            </ul>
