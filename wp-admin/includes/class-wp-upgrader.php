...
class Language_Pack_Upgrader extends WP_Upgrader {
    ...
    function check_package($source, $remote_source) {
        ...
        if (!$mo || !$po)
            return new WP_Error('incompatible_archive_pomo', $this->strings['incompatible_archive'], __('The language pack is missing either the <code>.po</code> or <code>.mo</code> files.'));
