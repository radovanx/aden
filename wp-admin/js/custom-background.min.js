!function(a) {
    a(document).ready(function() {
        ...
        a("#background-color").wpColorPicker({change: function(a, b) {
            ...
            var d = a(this);
            return c.preventDefault(), b ? void b.open() : (b = wp.media.frames.customBackground = wp.media({title: d.data("choose"), library: {type: "image"}, button: {text: d.data("update"), close: !1}}), b.on("select", function() {
