...
<div class="wrap about-wrap">
    ...
    <div class="changelog point-releases">
        ...
        <p><?php printf(_n('<strong>Version %1$s</strong> addressed %2$s bug.', '<strong>Version %1$s</strong> addressed %2$s bugs.', 34), '3.9.1', number_format_i18n(34));
            ?>
    ...
    <div class="changelog">
        <div class="about-overview">
            <?php if (!is_ssl() && ( $locale = get_locale() ) && 'en_' === substr($locale, 0, 3)) : ?>
        ...
        <div class="feature-section col three-col">
            <div class="col-1">
                ...
                <p><?php
                    _e('The updated visual editor has improved speed, accessibility, and mobile support.');
                    echo ' ' . __('You can paste into the visual editor from your word processor without wasting time to clean up messy styling. (Yeah, we&#8217;re talking about you, Microsoft Word.)');
                    ?></p>
            </div>
            <div class="col-2">
