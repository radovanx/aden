!function(a, b, c) {
    if (b && b.customize) {
        var d = b.customize;
        d.HeaderTool.CurrentView = b.Backbone.View.extend({template: b.template("header-current"), initialize: function() {
            ...
            }}), d.HeaderTool.ChoiceView = b.Backbone.View.extend({template: b.template("header-choice"), className: "header-view", events: {"click .choice,.random": "select", "click .close": "removeImage"}, initialize: function() {
            ...
            }, getHeight: d.HeaderTool.CurrentView.prototype.getHeight, setPlaceholder: d.HeaderTool.CurrentView.prototype.setPlaceholder, select: function() {
            ...
            }}), d.HeaderTool.ChoiceListView = b.Backbone.View.extend({initialize: function() {
            ...
            }}), d.HeaderTool.CombinedList = b.Backbone.View.extend({initialize: function(a) {
