...
!function(e, t) {
    ...
    r(l, [], function() {
        ...
        function h(e, t, n, i, o, a) {
            return i && !i[I] && (i = h(i)), o && !o[I] && (o = h(o, a)), r(function(r, a, s, l) {
                ...
                if (n && n(v, b, s, l), i)
                    for (c = m(b, p), i(c, [], s, l), u = c.length; u--; )
                        (d = c[u]) && (b[p[u]] = !(v[p[u]] = d));
                if (r) {
                    if (o || e) {
                        if (o) {
                    ...
                    b = m(b === a ? b.splice(h, b.length) : b), o ? o(null, a, b, l) : Z.apply(a, b)
            })
        }
        function g(e) {
        ...
        function v(e, t) {
            var n = 0, i = t.length > 0, a = e.length > 0, s = function(r, s, l, c, u) {
                var d, f, p, h = [], g = 0, v = "0", y = r && [], b = null != u, C = k, x = r || a && _.find.TAG("*", u && s.parentNode || s), N = W += null == C ? 1 : Math.random() || .1;
        ...
        var x, w, _, N, E, S, k, T, R, A, B, L, D, M, H, P, O, I = "sizzle" + -new Date, F = window.document, z = {}, W = 0, V = 0, U = n(), q = n(), $ = n(), j = !1, K = function() {
            return 0
        ...
        E = o.isXML = function(e) {
            ...
            if ((e.ownerDocument || e) !== B && A(e), t = t.replace(Ct, "='$1']"), z.matchesSelector && D && (!H || !H.test(t)) && !M.test(t))
                try {
                    var n = P.call(e, t);
                    ...
                    return 1 === r && 0 === i ? function(e) {
                        ...
                        if (g) {
                            ...
                            if (m = [a ? g.firstChild : g.lastChild], a && y) {
                                ...
                                for (; (d = ++p && d && d[h] || (f = p = 0) || m.pop()) && ((s?d.nodeName.toLowerCase() !== v:1 !== d.nodeType) || !++f || (y && ((d[I] || (d[I] = {}))[e] = [W, f]), d !== t)); )
                                    ;
        ...
        function t(n) {
            ...
            return $(M, {startContainer: H, startOffset: 0, endContainer: H, endOffset: 0, collapsed: F, commonAncestorContainer: H, START_TO_START: 0, START_TO_END: 1, END_TO_END: 2, END_TO_START: 3, setStart: i, setEnd: o, setStartBefore: a, setStartAfter: s, setEndBefore: l, setEndAfter: c, collapse: u, selectNode: d, selectNodeContents: f, compareBoundaryPoints: p, deleteContents: m, extractContents: h, cloneContents: g, insertNode: v, surroundContents: y, cloneRange: b, toStringIE: D}), M
        }
        ...
        return function(e, t) {
            ...
            function r(t, r, s) {
                ...
                if (o[t] ? v = o[t] : (v = {passed: [], failed: []}, o[t] = v), r && v.passed.push(r), s && v.failed.push(s), 1 != v.status) {
                    ...
                    if (3 == v.status)
                        return void c();
                    if (v.status = 1, m = e.createElement("link"), m.rel = "stylesheet", m.type = "text/css", m.id = "u" + i++, m.async = !1, m.defer = !1, g = (new Date).getTime(), "onload"in m && !u())
        ...
        return function(e) {
            ...
            function d(e) {
                var n, r, o, a, s, c, d, f, p, m, h, g, y, C, x, w, _, N, E, S = /^([#+\-])?([^\[!\/]+)(?:\/([^\[!]+))?(?:(!?)\[([^\]]+)\])?$/, k = /^([!\-])?(\w+::\w+|[^=:<]+)?(?:([=:<])(.*))?$/, T = /[*?+]/;
                if (e)
            ...
            i = i || {}, s.schema = o = o || new e, i.fix_self_closing !== !1 && (i.fix_self_closing = !0), r("comment cdata text start end pi doctype".split(" "), function(e) {
                ...
                function a(e, t, n, r, o) {
                    ...
                    if (W[t] && !i.allow_script_urls) {
                        var c = n.replace(l, "");
                        try {
                            if (c = decodeURIComponent(c), V.test(c))
                                return
                        } catch (u) {
                            if (c = unescape(c), V.test(c))
                                return
                        }
                    }
                    p.map[t] = n, p.push({name: t, value: n})
                }
                var s = this, l, c = 0, u, d, f = [], p, m, h, g, v, y, b, C, x, w, _, N, E, S, k, T, R, A, B, L, D, M, H, P, O, I = 0, F = t.decode, z, W = n.makeMap("src,href"), V = /(java|vb)script:/i;
        ...
        return function(r, l) {
            ...
            r = r || {}, r.validate = "validate"in r ? r.validate : !0, r.root_name = r.root_name || "body", u.schema = l = l || new t, u.filterNode = function(e) {
                ...
                var v, y, b, C, x, w, _, N, E, S, k, T, R, A = [], B, L, D, M, H, P, O, I;
        ...
        return function(r, i) {
            ...
            var C = i.dom, x = t.each, w, _, N, E, S, k, T, R, A, B, L, D, M, H, P, O = i.getDoc(), I = document, F = n.ie && n.ie < 11;
            ...
            this.walk = function(t, n) {
                ...
                function r(r) {
                    ...
                    if (c = n[(r ? "start" : "end") + "Container"], u = n[(r ? "start" : "end") + "Offset"], g = 1 == c.nodeType && u === c.childNodes.length, m = e.schema.getNonEmptyElements(), h = r, 1 == c.nodeType && u > c.childNodes.length - 1 && (h = !1), 9 === c.nodeType && (c = e.getRoot(), u = 0), c === f) {
                        if (h && (p = c.childNodes[u > 0 ? u - 1 : 0], p && (m[p.nodeName] || "TABLE" == p.nodeName)))
                            return;
        ...
        return s.prototype = {setCursorLocation: function(e, t) {
                ...
                var o = this, a = o.dom, s, c, u, d, f, p, m = "&#xFEFF;", h;
                if (2 == e)
                ...
                if (s = o.getRng(), u = a.uniqueId(), d = o.isCollapsed(), h = "overflow:hidden;line-height:0px", s.duplicate || s.item) {
                    ...
                    c = r(s.cloneRange()), d || (c.collapse(!1), c.insertNode(a.create("span", {"data-mce-type": "bookmark", id: u + "_end", style: h}, m))), s = r(s), s.collapse(!0), s.insertNode(a.create("span", {"data-mce-type": "bookmark", id: u + "_start", style: h}, m))
                }
                ...
                var i = this, o = i.dom, a, s, u, p, m, h;
                if (e)
                    if (e.start) {
                        ...
                        e.id ? (n("start"), n("end"), u && (a = o.createRng(), a.setStart(r(u), m), a.setEnd(r(p), h), i.setRng(a))) : e.name ? i.select(o.select(e.name)[e.index]) : e.rng && i.setRng(e.rng)
            }, select: function(e, t) {
        ...
        return function(i) {
            ...
            function m(t, n, r) {
                ...
                function c(e, t, n, r, i) {
                    ...
                    }), 0 >= a || a > l && c > a ? (nt(rt(e.childNodes), i), 0) : (u = z.clone(n, G), nt(rt(e.childNodes), function(e, t) {
                ...
                function d(e, r, i) {
                    ...
                    u = h.inline || h.block, d = z.create(u), a(d), V.walk(e, function(e) {
                        function m(e) {
                            ...
                            }), !h.inline || x) ? void(g = 0) : void(!p || w || !U(u, y) || !U(C, u) || !i && 3 === e.nodeType && 1 === e.nodeValue.length && 65279 === e.nodeValue.charCodeAt(0) || s(e) || h.inline && q(e) ? "li" == y && r ? g = c(e, r, d, l, m) : (g = 0, nt(rt(e.childNodes), m), w && (p = _), g = 0) : (g || (g = z.clone(d, G), e.parentNode.insertBefore(g, e), l.push(g)), g.appendChild(e)))
                        }
                        var g;
                        nt(e, m)
                        ...
                        function t(e) {
                            var n, r, i;
                            if ("A" === e.nodeName) {
                                for (r = z.clone(d, G), l.push(r), i = rt(e.childNodes), n = 0; n < i.length; n++)
                                    r.appendChild(i[n]);
                                e.appendChild(r)
                            }
                ...
                var f = u(t), h = f[0], g, y, b = !r && W.isCollapsed();
                if (h)
                    if (r)
            ...
            function A(t, n, r) {
                ...
                return(n[0].inline || n[0].block_expand) && (n[0].inline && 3 == g.nodeType && 0 !== v || (g = s(!0)), n[0].inline && 3 == y.nodeType && b !== y.nodeValue.length || (y = s())), n[0].selector && n[0].expand !== G && !n[0].inline && (g = d(g, "previousSibling"), y = d(y, "nextSibling")), (n[0].block || n[0].selector) && (g = f(g, "previousSibling"), y = f(y, "nextSibling"), n[0].block && (q(g) || (g = s(!0)), q(y) || (y = s()))), 1 == g.nodeType && (v = j(g), g = g.parentNode), 1 == y.nodeType && (b = j(y) + 1, y = y.parentNode), {startContainer: g, startOffset: v, endContainer: y, endOffset: b}
            }
            function B(e, t, n, r) {
                var i, o, a;
                if (!_(n, e))
            ...
            function O(t, n, r) {
                ...
                function p() {
                    var e = W.getRng(!0), t, i, s, l, c, d, f = [], p, m;
                    ...
                    if (d)
                        if (l)
                            s = W.getBookmark(), e.collapse(!0), e = A(e, u(n), !0), e = V.split(e), h(n, r, e), W.moveToBookmark(s);
                        else {
            ...
            var F = {}, z = i.dom, W = i.selection, V = new t(z), U = i.schema.isValidChild, q = z.isBlock, $ = i.settings.forced_root_block, j = z.nodeIndex, K = "\ufeff", Y = /^(src|href|style)$/, G = !1, X = !0, J, Q, Z = z.getContentEditable, et, tt, nt = n.each, rt = n.grep, it = n.walk, ot = n.extend;
            ot(this, {get: u, register: d, apply: m, remove: h, toggle: g, match: y, matchAll: b, matchNode: v, canApply: C, formatChanged: x, getCssText: w}), l(), c(), i.on("BeforeGetContent", function() {
                tt && tt()
            ...
            function o(o) {
                ...
                function h(t) {
                    ...
                    if (l = a.createRng(), t.hasChildNodes()) {
                        ...
                        "BR" == t.nodeName ? t.nextSibling && a.isBlock(t.nextSibling) ? ((!L || 9 > L) && (u = a.create("br"), t.parentNode.insertBefore(u, t)), l.setStartBefore(t), l.setEndBefore(t)) : (l.setStartAfter(t), l.setEndAfter(t)) : (l.setStart(t, 0), l.setEnd(t, 0));
        ...
        return function(r) {
            ...
            o(this, {execCommand: p, queryCommandState: m, queryCommandValue: h, addCommands: g}), g({"mceResetDesignMode,mceBeginUndoLevel": function() {
                    ...
                    if (C.invalid) {
                        ...
                        i = s.serialize(d), h = l.firstChild, g = l.lastChild, !h || h === g && "BR" === h.nodeName ? w.setHTML(l, i) : _.setContent(i);
        ...
        var i = t.makeMap("focusin focusout scroll click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave wheel keydown keypress keyup contextmenu", " "), o = {}, a = "onmousewheel"in document, s = !1, l = "mce-", c = e.extend({Statics: {elementIdCache: o, classPrefix: l}, isRtl: function() {
                ...
                var n = this, i, o;
                if (n.settings = e = t.extend({}, n.Defaults, e), n._id = e.id || r.id(), n._text = n._name = "", n._width = n._height = 0, n._aria = {role: e.role}, i = e.classes)
                ...
                return e._layoutRect = i = {x: t.x || 0, y: t.y || 0, w: a, h: s, deltaW: m, deltaH: h, contentW: a - m, contentH: s - h, innerW: a - m, innerH: s - h, startMinWidth: d || 0, startMinHeight: f || 0, minW: Math.min(l, g), minH: Math.min(c, v), maxW: g, maxH: v, autoResize: u, scrollW: 0}, e._lastLayoutRect = {}, i
                ...
                if (t)
                    for ("string" == typeof t && (t = n(t)), s = e.toLowerCase().split(" "), l = s.length; l--; )
                        e = s[l], o = r._bindings, o || (o = r._bindings = {}), a = o[e], a || (a = o[e] = []), a.push(t), i[e] && (r._nativeEvents || (r._nativeEvents = {}), r._nativeEvents[e] = !0, r._rendered && r.bindPendingEvents());
                return r
            }, off: function(e, t) {
        ...
        return function(a) {
            ...
            function d() {
                ...
                a.on("keydown", function(e) {
                    var t = e.keyCode, r, i;
                    if (!c(e) && (t == V || t == W)) {
                        if (r = a.selection.isCollapsed(), i = a.getBody(), r && !U.isEmpty(i))
                            return;
            ...
            function m() {
                a.on("keydown", function(e) {
                    if (!c(e) && e.keyCode === W && q.isCollapsed() && 0 === q.getRng(!0).startOffset) {
                        ...
                        if ("HR" == t.nodeName)
                            return U.remove(t), void e.preventDefault();
            ...
            var z = o.each, W = e.BACKSPACE, V = e.DELETE, U = a.dom, q = a.selection, $ = a.settings, j = a.parser, K = a.serializer, Y = i.gecko, G = i.ie, X = i.webkit;
            C(), _(), d(), L(), X && (u(), p(), g(), S(), i.iOS ? (y(), M(), H(), F()) : f()), G && i.ie < 11 && (m(), b(), x(), w(), T(), R(), A(), B()), i.ie >= 11 && (H(), I()), i.ie && (f(), O()), Y && (m(), h(), v(), N(), E(), k(), D(), P())
        }
    }), r(it, [p], function(e) {
        function t() {
            return!1
        ...
        return{fire: function(e, i, o) {
                ...
                if (t === !1 && (t = function() {
                    ...
                    for (l = e.toLowerCase().split(" "), c = l.length; c--; )
        ...
        var E = e.DOM, S = n.ThemeManager, k = n.PluginManager, T = C.extend, R = C.each, A = C.explode, B = C.inArray, L = C.trim, D = C.resolve, M = m.Event, H = b.gecko, P = b.ie;
        return N.prototype = {render: function() {
                ...
                if (document.domain != location.hostname && (u = v), s = E.add(l.iframeContainer, "iframe", {id: t.id + "_ifr", src: u || 'javascript:""', frameBorder: "0", allowTransparency: "true", title: t.editorManager.translate("Rich Text Area. Press ALT-F9 for menu. Press ALT-F10 for toolbar. Press ALT-0 for help"), style: {width: "100%", height: o, display: "block"}}), P)
                    try {
                        t.getDoc()
                    } catch (y) {
                        s.src = u = v
                ...
                if (n && t.initialized)
                    return e = e || {}, e.save = !0, e.element = n, r = e.content = t.getContent(e), e.no_events || t.fire("SaveContent", e), r = e.content, /TEXTAREA|INPUT/i.test(n.nodeName) ? n.value = r : (t.inline || (n.innerHTML = r), (i = E.getParent(t.id, "form")) && R(i.elements, function(e) {
            ...
            function d(n) {
                ...
                d.on("init", function() {
                    (d.inline || t.ie) && (d.on("nodechange keyup", function() {
                        ...
                        e && e.id == d.id + "_ifr" && (e = d.getBody()), u(e, d) && (d.lastRng = d.selection.getRng())
                    ...
                    d.selection.lastFocusBookmark && (d.selection.setRng(l(d, d.selection.lastFocusBookmark)), d.selection.lastFocusBookmark = null), t != d && (t && t.fire("blur", {focusedEditor: d}), e.activeEditor = d, e.focusedEditor = d, d.fire("focus", {blurredEditor: t}), d.focus(!0)), d.lastRng = null
                }), d.on("focusout", function() {
                    window.setTimeout(function() {
                        var t = e.focusedEditor;
                        c(a()) || t != d || (d.fire("blur", {focusedEditor: null}), e.focusedEditor = null, d.selection && (d.selection.lastFocusBookmark = null))
                    }, 0)
                }), i || (i = function(t) {
        ...
        var l = t.DOM, c = i.explode, u = i.each, d = i.extend, f = 0, p, m = {majorVersion: "4", minorVersion: "0.21.1", releaseDate: "2014-04-09", editors: [], i18n: a, activeEditor: null, setup: function() {
                var e = this, t, r, i = "", o;
                ...
                function a() {
                    var h, g;
                    if (l.unbind(window, "ready", a), i(t, "onpageload"), t.types)
                        return void u(t.types, function(e) {
                            u(l.select(e.selector), function(i) {
                                r(n(i), d({}, t, e))
                            })
                        });
                    if (t.selector)
                        return void u(l.select(t.selector), function(e) {
                            r(n(e), t)
                        });
                    switch (t.mode) {
                        case"exact":
                            h = t.elements || "", h.length > 0 && u(c(h), function(n) {
                                l.get(n) ? (m = new e(n, t, s), p.push(m), m.render()) : u(document.forms, function(e) {
                                    u(e.elements, function(e) {
                ...
                var t = this, n, r = t.editors, i, o;
                {
                    if (e) {
                        if ("string" == typeof e)
                            return e = e.selector || e, void u(l.select(e), function(e) {
                                t.remove(r[e.id])
                            });
                        if (i = e, !r[i.id])
                            return null;
        ...
        return d(m, o), m.setup(), window.tinymce = window.tinyMCE = m, m
        ...
        return e.extend({recalc: function(e) {
                var t, n, r, i, o, a, s, l, c, u, d, f, p, m, h, g, v = [], y, b, C, x, w, _, N, E, S, k, T, R, A, B, L, D, M, H, P, O, I, F, z = Math.max, W = Math.min;
        ...
        return e.extend({recalc: function(e) {
                var t = e.settings, n, r, i, o, a, s, l, c, u, d, f, p, m, h, g, v, y, b, C, x, w, _, N = [], E = [], S, k, T, R;
    ...
    }), a([l, c, u, d, f, p, m, h, g, v, y, b, C, x, w, _, N, E, S, k, T, R, A, B, L, D, M, H, P, O, I, F, z, W, V, U, q, $, j, K, Y, G, X, J, Q, Z, et, tt, nt, rt, it, ot, at, st, lt, ct, ut, dt, ft, pt, mt, ht, gt, vt, yt, bt, Ct, xt, wt, _t, Nt, Et, St, kt, Tt, Rt, At, Bt, Lt, Dt, Mt, Ht, Pt, Ot, It, Ft, zt, Wt, Vt, Ut, qt, $t, jt, Kt, Yt, Gt, Xt, Jt, Qt, Zt])
}(this);