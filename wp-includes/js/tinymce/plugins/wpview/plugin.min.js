tinymce.PluginManager.add("wpview", function(a) {
    ...
    function h(b) {
        var c, d = a.dom;
        b !== l && (i(), l = b, d.addClass(b, "selected"), c = d.create("div", {"class": "wpview-clipboard", contenteditable: "true"}, e(b)), b.insertBefore(c, b.firstChild), d.bind(c, "beforedeactivate focusin focusout", g), d.bind(l, "beforedeactivate focusin focusout", g), a.getBody().focus(), a.selection.select(c, !0))
    }
    function i() {
        var b, c = a.dom;
    ...
    if ("undefined" != typeof wp && wp.mce)
        return a.on("BeforeAddUndo", function(a) {
            ...
            if (l) {
                if (e.metaKey || e.ctrlKey || j >= 112 && 123 >= j)
                    return void((e.metaKey || e.ctrlKey) && 88 === j && (o = l));
                if (f = b(a.selection.getNode()), f !== l)
                    return void i();
            ...
            if (h && h !== i && !b.metaKey && !b.ctrlKey)
                if (e === m.UP || e === m.LEFT) {
                    if (e === m.LEFT && (!g.collapsed || 0 !== g.startOffset))
                        return;
                    if (!(c = f.getParent(h, f.isBlock)))
                        return;
                    ...
                    if (!(c = f.getParent(h, f.isBlock)))
                        return;
                    if (e === m.RIGHT) {
                        if (d = g.endContainer, !g.collapsed || 0 === g.startOffset && d.length || d.nextSibling || 3 === d.nodeType && g.startOffset !== d.length)
                            return;
                        for (; d && d !== c && d !== i; ) {
                            if (d.nextSibling)
                                return;
