...
function cptbc_image_url() {
    ...
    <label><input type="checkbox" name="cptbc_image_url_openblank" <?php
        ...
        ?> value="1" /> <?php _e('Open link in new window?', 'cpt-bootstrap-carousel'); ?></label>
        <?php
    }
...
///////////////////
    ...
    public function interval_callback() {
        printf('<input type="text" id="interval" name="cptbc_settings[interval]" value="%s" size="6" />', isset($this->options['interval']) ? esc_attr($this->options['interval']) : '');
    }
