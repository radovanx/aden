...
jQuery(document).ready(function($) {  
  ...
  $('#watermark_run_restore').click(function() {
    ...
    $.post(ajaxurl, {action: 'smart_watermark_stat'}, 
        function(response) {
            ...
            smart_watermark_restore_procced();
        }); 
     });
     
     function smart_watermark_restore_procced() {
        $.post(
        ajaxurl,  
        {action: 'smartwatermark_restore', offset:smart_watermark_current_offset, limit:smart_watermark_bulk_limit}, 
        function(response) {
