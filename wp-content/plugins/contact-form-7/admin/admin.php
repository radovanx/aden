...
function wpcf7_admin_menu() {
    ...
    add_object_page(__('Contact Form 7', 'contact-form-7'), __('Contact', 'contact-form-7'), 'wpcf7_read_contact_forms', 'wpcf7', 'wpcf7_admin_management_page', $icon_url);
...
function wpcf7_admin_enqueue_scripts($hook_suffix) {
    ...
    wp_enqueue_script('wpcf7-admin', wpcf7_plugin_url('admin/js/scripts.js'), array('jquery', 'postbox', 'wpcf7-admin-taggenerator'), WPCF7_VERSION, true);
...
function wpcf7_add_meta_boxes($post_id) {
    add_meta_box('formdiv', __('Form', 'contact-form-7'), 'wpcf7_form_meta_box', null, 'form', 'core');

    add_meta_box('maildiv', __('Mail', 'contact-form-7'), 'wpcf7_mail_meta_box', null, 'mail', 'core');

    add_meta_box('mail2div', __('Mail (2)', 'contact-form-7'), 'wpcf7_mail_meta_box', null, 'mail_2', 'core', array(
        'id' => 'wpcf7-mail-2',
        'name' => 'mail_2',
        'use' => __('Use mail (2)', 'contact-form-7')));

    add_meta_box('messagesdiv', __('Messages', 'contact-form-7'), 'wpcf7_messages_meta_box', null, 'messages', 'core');

    add_meta_box('additionalsettingsdiv', __('Additional Settings', 'contact-form-7'), 'wpcf7_additional_settings_meta_box', null, 'additional_settings', 'core');
