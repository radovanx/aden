...
function wpcf7_add_shortcode_text() {
    wpcf7_add_shortcode(
            array('text', 'text*', 'email', 'email*', 'url', 'url*', 'tel', 'tel*'), 'wpcf7_text_shortcode_handler', true);
}
...
function wpcf7_add_tag_generator_text() {
    ...
    wpcf7_add_tag_generator('text', __('Text field', 'contact-form-7'), 'wpcf7-tg-pane-text', 'wpcf7_tg_pane_text');

    wpcf7_add_tag_generator('email', __('Email', 'contact-form-7'), 'wpcf7-tg-pane-email', 'wpcf7_tg_pane_email');

    wpcf7_add_tag_generator('url', __('URL', 'contact-form-7'), 'wpcf7-tg-pane-url', 'wpcf7_tg_pane_url');

    wpcf7_add_tag_generator('tel', __('Telephone number', 'contact-form-7'), 'wpcf7-tg-pane-tel', 'wpcf7_tg_pane_tel');
}
