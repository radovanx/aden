...
function wpcf7_add_tag_generator_number() {
    ...
    wpcf7_add_tag_generator('number', __('Number (spinbox)', 'contact-form-7'), 'wpcf7-tg-pane-number', 'wpcf7_tg_pane_number');

    wpcf7_add_tag_generator('range', __('Number (slider)', 'contact-form-7'), 'wpcf7-tg-pane-range', 'wpcf7_tg_pane_range');
}
