...
function wpcf7_add_shortcode_date() {
    wpcf7_add_shortcode(array('date', 'date*'), 'wpcf7_date_shortcode_handler', true);
}
...
function wpcf7_add_tag_generator_date() {
    ...
    wpcf7_add_tag_generator('date', __('Date', 'contact-form-7'), 'wpcf7-tg-pane-date', 'wpcf7_tg_pane_date');
}
