...
if (!class_exists('Theme_My_Login_Themed_Profiles_Admin')) :
    ...
    class Theme_My_Login_Themed_Profiles_Admin extends Theme_My_Login_Abstract {
        ...
        public function admin_menu() {
            add_submenu_page(
                    'theme_my_login', __('Theme My Login Themed Profiles Settings', 'theme-my-login'), __('Themed Profiles', 'theme-my-login'), 'manage_options', $this->options_key, array(&$this, 'settings_page')
            );
