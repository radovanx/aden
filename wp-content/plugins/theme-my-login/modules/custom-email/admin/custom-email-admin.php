...
if (!class_exists('Theme_My_Login_Custom_Email_Admin')) :
    ...
    class Theme_My_Login_Custom_Email_Admin extends Theme_My_Login_Abstract {
        ...
        public function admin_menu() {
            ...
            add_submenu_page(
                    'theme_my_login', __('Theme My Login Custom E-mail Settings', 'theme-my-login'), __('E-mail', 'theme-my-login'), 'manage_options', $this->options_key, array(&$this, 'settings_page')
            );

            add_meta_box('new_user', __('New User', 'theme-my-login'), array(&$this, 'new_user_meta_box'), 'tml_page_' . $this->options_key, 'normal');

            //
            add_meta_box('frozen_user', __('Freeze User', 'theme-my-login'), array(&$this, 'frozen_user_meta_box'), 'tml_page_' . $this->options_key, 'normal');
        ...
        /**
         * Renders Frozen User Notification settings section
         *
         * This is the callback for add_meta_box()
         *
         * @since 6.3
         * @access public
         */
        public function frozen_user_meta_box() {
            ?>
            <p class="description">
                <?php _e('This e-mail will be sent to user upon freeze.', 'theme-my-login'); ?>
            </p>
            <table class="form-table">
                <tr valign="top">
                    <th scope="row"><label for="<?php echo $this->options_key; ?>_frozen_user_mail_from_name"><?php _e('From Name', 'theme-my-login'); ?></label></th>
                    <td><input name="<?php echo $this->options_key; ?>[frozen_user][mail_from_name]" type="text" id="<?php echo $this->options_key; ?>_frozen_user_mail_from_name" value="<?php echo $this->get_option(array('frozen_user', 'mail_from_name')); ?>" class="regular-text" /></td>
                </tr>
                <tr valign="top">
                    <th scope="row"><label for="<?php echo $this->options_key; ?>_frozen_user_mail_from"><?php _e('From E-mail', 'theme-my-login'); ?></label></th>
                    <td><input name="<?php echo $this->options_key; ?>[frozen_user][mail_from]" type="text" id="<?php echo $this->options_key; ?>_frozen_user_mail_from" value="<?php echo $this->get_option(array('frozen_user', 'mail_from')); ?>" class="regular-text" /></td>
                </tr>
                <tr valign="top">
                    <th scope="row"><label for="<?php echo $this->options_key; ?>_frozen_user_mail_content_type"><?php _e('E-mail Format', 'theme-my-login'); ?></label></th>
                    <td>
                        <select name="<?php echo $this->options_key; ?>[frozen_user][mail_content_type]" id="<?php echo $this->options_key; ?>_frozen_user_mail_content_type">
                            <option value="plain"<?php selected($this->get_option(array('frozen_user', 'mail_content_type')), 'plain'); ?>><?php _e('Plain Text', 'theme-my-login'); ?></option>
                            <option value="html"<?php selected($this->get_option(array('frozen_user', 'mail_content_type')), 'html'); ?>><?php _e('HTML', 'theme-my-login'); ?></option>
                        </select>
                    </td>
                </tr>
                <tr valign="top">
                    <th scope="row"><label for="<?php echo $this->options_key; ?>_frozen_user_title"><?php _e('Subject', 'theme-my-login'); ?></label></th>
                    <td><input name="<?php echo $this->options_key; ?>[frozen_user][title]" type="text" id="<?php echo $this->options_key; ?>_frozen_user_title" value="<?php echo $this->get_option(array('frozen_user', 'title')); ?>" class="large-text" /></td>
                </tr>
                <tr valign="top">
                    <th scope="row"><label for="<?php echo $this->options_key; ?>_frozen_user_message"><?php _e('Message', 'theme-my-login'); ?></label></th>
                    <td>
                        <p class="description"><?php _e('Available Variables', 'theme-my-login'); ?>: %siteurl%, %user_email%, %user_firstname%, %user_lastname%</p>
                        <textarea name="<?php echo $this->options_key; ?>[frozen_user][message]" id="<?php echo $this->options_key; ?>_frozen_user_message" class="large-text" rows="10"><?php echo $this->get_option(array('frozen_user', 'message')); ?></textarea></p>
                    </td>
                </tr>
            </table>
            <?php
