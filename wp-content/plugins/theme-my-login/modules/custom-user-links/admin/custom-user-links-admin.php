...
if (!class_exists('Theme_My_Login_Custom_User_Links_Admin')) :
    ...
    class Theme_My_Login_Custom_User_Links_Admin extends Theme_My_Login_Abstract {
        ...
        public function admin_menu() {
            ...
            add_submenu_page(
                    'theme_my_login', __('Theme My Login Custom User Links Settings', 'theme-my-login'), __('User Links', 'theme-my-login'), 'manage_options', $this->options_key, array(&$this, 'settings_page')
            );
