...
if (!class_exists('Theme_My_Login_Custom_Redirection_Admin')) :
    ...
    class Theme_My_Login_Custom_Redirection_Admin extends Theme_My_Login_Abstract {
        ...
        public function admin_menu() {
            ...
            add_submenu_page(
                    'theme_my_login', __('Theme My Login Custom Redirection Settings', 'theme-my-login'), __('Redirection', 'theme-my-login'), 'manage_options', $this->options_key, array(&$this, 'settings_page')
            );
