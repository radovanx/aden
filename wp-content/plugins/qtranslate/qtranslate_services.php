            ...
            foreach ($services as $service_id => $service) {
                ...
                foreach ($service['service_required_fields'] as $field) {
                    if (isset($_POST['qs_' . $service_id . '_' . $field['name']])) {
                        ...
                        if ($_POST['qs_' . $service_id . '_' . $field['name']] == '' && $field['name'] == 'password')
                            continue;
                ...
                <div id="qs_boxes" class="metabox-holder">
                    <div class="postbox">
                        ...
                        <div class="postbox closed">
                            <div class="handlediv" title="<?php _e('Click to toggle'); ?>" onclick="jQuery(this).parent().removeClass('closed');
                                    jQuery(this).hide();"><br></div>
