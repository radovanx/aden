        ...
        <div class="panel-body">
            ...
            <span class="propertyListBoxDataItemName">
                ...
                <span class="pull-right">
                    <?php echo esc_attr(get_post_meta($post->ID, '_program_street', true)); ?> <?php echo esc_attr(get_post_meta($post->ID, '_program_house_number', true)); ?>, <?php echo esc_attr(get_post_meta($post->ID, '_program_region', true)); ?> <?php echo esc_attr(get_post_meta($post->ID, '_program_city', true)); ?>
                </span>
            </span>
