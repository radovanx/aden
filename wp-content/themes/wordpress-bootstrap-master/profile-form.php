...
<div class="login profile row" id="theme-my-login<?php $template->the_instance(); ?>">
    <div class="col-md-12 column">
        ...
        <form id="your-profile" class="border background clearfix searchform" action="<?php $template->the_action_url('profile'); ?>" method="post" enctype='multipart/form-data'>
            ...
            <div class="col-md-12 column">
                <div class="col-md-6 column">
                    ...
                    <h4><?php _e('New password', 'wpbootstrap'); ?></h4>
