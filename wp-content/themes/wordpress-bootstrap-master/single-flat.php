                                ...
                                <div class="border col-md-12 column">
                                    <div class="row clearfix">
                                        <div class="col-md-12 column product-key-info">
                                            ...
                                            <a href="/generate-pdf/product/product_id" class="blue clearfix printlink"><i class="fa fa-print"></i> <?php _e("Print presentation", "wpbootstrap"); ?></a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" id="send_recommendation"><?php _e('Send recommendation', 'wpbootstrap') ?></button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
